    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            */
            ...
            //date picker
            //  bundles.Add(new StyleBundle("~/plugins/datetimepicker").Include(
            //            "~/Scripts/plugins/datetimepicker/bootstrap-datepicker.js"));
            //   bundles.Add(new StyleBundle("~/plugins/datetimepicker").Include(
            //     "~/Content/plugins/datetimepicker/css/datetimepicker.css"));


            //date range picker
          /*  bundles.Add(new StyleBundle("~/plugins/dateRange").Include(
                      "~/Content/plugins/daterangepicker/jquery.comiseo.daterangepicker.css"));


            bundles.Add(new ScriptBundle("~/plugins/dateRange").Include(

                      "~/Content/plugins/daterangepicker/moment.min.js",
                      "~/Content/plugins/daterangepicker/jquery.comiseo.daterangepicker.js"));
                      */
